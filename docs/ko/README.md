...
한국어 기본 문서입니다. 영문 대응 문서와 같은 설계를 유지합니다.

- [C4 모델](architecture/c4.md)
- [arc42](arc42.md)
- [ADR 목록](adr/README.md)
- [API 계약](api-contract.md)
- [제품 범위](product-scope.md)
- [수집·갱신 설계](watchlist-update-design.md)
- [운영 안내](runbook.md)
- [검증 안내](evaluation-harness.md)
- [ADR 0001](adr/0001-web-api-relational-storage.md)
- [ADR 0002](adr/0002-versioned-snapshots.md)
